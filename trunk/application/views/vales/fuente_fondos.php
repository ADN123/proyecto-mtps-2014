...
<section>
    <h2>Control de fuente de fondos</h2>
</section>
...
?>
  <tr>
    ...
    <td>
    	<a class="modificar" title="Modificar <?php echo $titulo?>" rel="leanModal" href="#ventana" data-id_fuente_fondo="<?php echo $val['id_fuente_fondo']?>" data-nombre="<?php echo ucwords($val['nombre'])?>"><img src="<?php echo base_url()?>img/lupa.gif"/></a>
